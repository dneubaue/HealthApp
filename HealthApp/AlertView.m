...
- (id)init
{
    ...
    if (self) {
        ...
        [self setFrame:frame];
        [self setBackgroundColor:[UIColor colorWithRed:(70/255.0) green:(70/255.0) blue:(70/255.0) alpha:0.7]];
...
- (void)drawRect:(CGRect)rect
{
    ...
    // Main
    UIView *mainView = [[UIView alloc] initWithFrame:CGRectMake((320-248)/2.0, 75, 248, 166)];
